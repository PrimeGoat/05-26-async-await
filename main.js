...
async function getOrder(promise) {
...
async function practice(prom1, prom2, prom3, subject) {
    let out1 = await prom1(subject);
    let out2 = await prom2(subject);
    let out3 = await prom3(subject);
...
practice(needToStart, working, finished, "JavaScript");
